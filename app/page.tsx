...
const featuredProjects = [
  {
    ...
    description: "Documentales y videos que impulsan el cambio social y visibilizan causas importantes.",
    image: "https://picsum.photos/seed/social1/800/600",
    tags: ["Documental", "ONG", "Fundación"],
  },
  {
    id: 2,
    title: "Proyecto Empresarial",
    category: "CORPORATIVO",
    description: "Contenido audiovisual que potencia la comunicación y marketing de empresas.",
    image: "https://picsum.photos/seed/business1/800/600",
    tags: ["Comercial", "Branding", "Marca"],
  },
  {
    id: 3,
    title: "Proyecto Propio",
    category: "CREATIVO",
    description: "Producciones originales que exploran narrativas únicas y visión artística.",
    image: "https://picsum.photos/seed/creative1/800/600",
    tags: ["Arte", "Cine", "Experimental"],
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="bg-zinc-900 text-white px-8 py-20 lg:px-16 lg:py-24 flex flex-col justify-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light leading-tight mb-8">
            Historias que
            <br />
            <span className="font-semibold">transforman</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed max-w-md">
              Producción audiovisual profesional para organizaciones, empresas y proyectos que buscan impactar a través del contenido visual.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-zinc-400">
              <a href="mailto:contacto@camarauno.com" className="hover:text-white transition-colors">
